...
public class HeadohoneRunner {

	public static void main(String[] args) {
		HeadphoneDTO headphoneDTO = new HeadphoneDTO(Brand.BOAT, Color.WHITE, TypeAndWeight.WIRELESS, "Rockerzz", "Shiva" , 2727, 1, 26556d, true, LocalDate.of(2020, 3, 15));
